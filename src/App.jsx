...
/**
 * Language Context per Multi-language
 */
...
function getAlternatives(productType, mainSize) {
  ...
  if (index > 0) {
    alts.push({ size: sizes[index - 1], reason: 'Tighter fit' });
  }
  if (index < sizes.length - 1) {
    alts.push({ size: sizes[index + 1], reason: 'Relaxed fit' });
  }
...
async function exportResultsToPDF(results, measurements, fitPreference, language) {
  try {
    ...
    const theme = language === 'it' ? 'italiano' : language === 'es' ? 'español' : language === 'fr' ? 'français' : 'English';
...
function ARTryOn({ productKey, size }) {
  ...
  return (
    <div
      className="p-6 rounded-lg mb-4 animate-fade-in"
        ...
        <div className="text-center">
          <div
            ...
            style={{
              ...
              filter: productKey === 'tee' ? 'drop-shadow(0 0 20px rgba(116, 130, 188, 0.3))' : 'none'
            }}
          >
            👤
          </div>
...
function MeasurementInput({ field, label, value, onChange, error, helper }) {
  ...
  return (
    <div className="mb-6 animate-slide-in" style={{ animationDelay: `${Math.random() * 0.2}s` }}>
      ...
      <div className="relative">
        ...
        />
        <span className="absolute right-4 top-3 text-sm" style={{ color: theme.textMuted }}>
          cm
        </span>
      </div>
      {error && (
...
function ResultCard({ productKey, recommendation }) {
  ...
  const handleAddToCart = () => {
    ...
    window.open(`/shop/${PRODUCTS[productKey].shopifyHandle}?variant=${recommendation.size}`, '_blank');
  };
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          ...
          {recommendation.tomboy && (
            <div className="text-xs font-semibold mt-1" style={{ color: theme.primary }}>
              Tom Boy
            </div>
          )}
        </div>
      ...
      >
        ...
        {addedToCart ? '✓ Added!' : `Add Size ${recommendation.size} to Cart`}
      </button>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 md:py-12">
          ...
          >
            ...
            <button
              onClick={() => {
                ...
                setFitPreference(savedProfile.fitPreference);
              }}
        ...
        {step === 1 && (
          <div
            className="rounded-lg shadow-lg p-8 mb-6 animate-fade-in"
            style={{
              backgroundColor: theme.bgAlt,
              border: `1px solid ${theme.border}`
            }}
          >
            ...
            <MeasurementInput
              ...
              onChange={handleInputChange}
              error={measurementErrors.chest}
              helper="Around the widest point of chest"
            />
            <MeasurementInput
              field="waist"
              label={t('waist')}
              ...
              onChange={handleInputChange}
              error={measurementErrors.waist}
              helper="Where you normally wear pants"
            />
            <MeasurementInput
              field="hips"
              label={t('hips')}
            ...
            <MeasurementInput
              ...
              onChange={handleInputChange}
              error={measurementErrors.inseam}
              helper="From crotch to ankle"
            />

            {calculationError && (
              <div
                className="mb-6 p-4 rounded-lg flex items-start gap-3 animate-slide-in"
                style={{
            ...
            <button
              ...
              disabled={!areMeasurementsValid || isCalculating}
        ...
        {step === 2 && (
          ...
          >
            ...
            <p style={{ color: theme.textMuted }} className="mb-8">
              Fit is personal. Choose deliberately.
            </p>
            ...
            <div className="space-y-4 mb-8">
              {fitOptions.map((opt, idx) => (
                ...
                >
                  ...
                  <div className="text-sm mt-2" style={{ opacity: fitPreference === opt.key ? 0.9 : 0.7 }}>
                    {opt.desc}
                  </div>
                </button>
              ))}
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setStep(1)}
                className="flex-1 py-4 rounded-lg font-bold border-2 transition-all hover:opacity-80"
        ...
        {step === 3 && results && (
          <div className="space-y-6 mb-6">
            ...
            {/* Your Sizes Summary */}
            <div
              className="rounded-lg shadow-lg p-6 animate-fade-in"
              style={{
                backgroundColor: theme.bgAlt,
                border: `1px solid ${theme.border}`
              }}
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => exportResultsToPDF(results, measurements, fitPreference, 'en')}
                    className="px-4 py-2 rounded-lg border-2 text-sm font-semibold flex items-center gap-2 hover:opacity-80 transition-all"
                    style={{ borderColor: theme.primary, color: theme.primary }}
                  >
                    <Download size={16} />
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          {Object.entries(rec.measurements).map(([mKey, mVal]) => (
                            <div key={mKey}>
                              ...
                              <span className="font-semibold ml-1" style={{ color: theme.text }}>
                                {mVal}cm
                              </span>
                            </div>
                          ))}
            ...
            >
              ...
              <p className="text-center text-sm mt-6" style={{ color: theme.textMuted }}>
                Ready to order?{' '}
                <a href="/" className="font-semibold hover:opacity-70" style={{ color: theme.primary }}>
                  Explore KOMO →
                </a>
              </p>
            </div>
